...
import { Clock, ShieldAlert, CheckCircle2, User, ChevronRight } from "lucide-react";
...
export default async function AstrologerDashboard() {
  ...
  if (!profile) {
    // Should theoretically not happen as we create it on register
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div className="text-center sm:text-left mt-2 sm:mt-0">
            ...
            <p className="text-white/80 max-w-lg">
              Welcome to your AstroGuru Partner Dashboard. Manage your appointments, update your profile, and guide seekers on their journey.
            </p>
          </div>
        </div>
